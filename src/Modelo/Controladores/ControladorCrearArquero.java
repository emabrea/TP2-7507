...
public class ControladorCrearArquero implements EventHandler<ActionEvent>{
	...
	public ControladorCrearArquero(ContenedorPrincipal contenedor, Cuartel cuartel){
    ...
    public void handle(ActionEvent event) {
        try{
            ...
            this.cuartel.crearArquero(this.cuartel.posiblesCeldasParaCrearArquero().get(0));
